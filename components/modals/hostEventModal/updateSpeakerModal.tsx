...
import UpdateSpeakerForm from "fragments/hostEvent/updateSpeakerForm";

interface IUpdateSpeakerModal {
  isOpen: boolean;
  onRequestClose: () => void;
...
const UpdateSpeakerModal = (props: IUpdateSpeakerModal) => {
    ...
    >
     {!isTablet &&  <div
      ...
      >
            ...
            >
              <UpdateSpeakerForm setGetPerformers = {props.setGetPerformers} handleModalClose = {handleClose} id = {props.id}/>
            </div>
      </div>
    </Modal>
  );
