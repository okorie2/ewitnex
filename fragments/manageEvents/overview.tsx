              ...
              <div>
                ...
                >
                  ...
                  <div
                    css={{ cursor: "pointer" }}
                    onClick={() =>
                      handleCopy(`${event.eventCode}`, "Event ID Copied!")
                    }
                  >
                    <Image
                      src="/assets/svgs/copy2.svg"
            ...
            >
              ...
              >
                ...
                <p css={{ fontSize: "0.75rem", color: "#AEAEAE" }}>
                  Payment will be processed to your wallet 3-5 working days
                  after event has been completed.
                </p>
              </div>
              <div
                css={{
                  ...
                  >
                    ...
                    >
                      ...
                      <div css={{ marginTop: isTablet ? "" : "2rem" }}>
                        ...
                        <p css={{ fontWeight: "bold" }}>{`0/${getTicketQuantity(
                          event
                        )}`}</p>
                      </div>
                    </div>
