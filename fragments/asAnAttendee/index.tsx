...
const AsAnAttendeeFragment = () => {
  ...
  return (
    ...
    >
      ...
      <H1 color={"#000"} small>
        Discover Your Next Unforgettable {!isTablet && <br />}{" "}
        <span css={{ color: "#00d9b7" }}>Event</span> With Ewitnex.
      </H1>
      <div
        css={{
          width: isTablet ? "95%" : "55%",
          fontSize: isTablet ? "0.85rem" : "",
        }}
      >
        <p>
          Ewitnex offers a curated selection of exciting gatherings,
          conferences, concerts, and more, allowing you to easily find and
          attend the {isTablet && <br />}events that match your interests and
          {isTablet && <br />} passions.
        </p>
      </div>
      <div
        css={{
