...
const Wallet = () => {
  ...
  return (
    <>
      <FundWalletModal isOpen={fundWalletModalOpen} onRequestClose={() => setFundWalletModalOpen(!fundWalletModalOpen)} />
      <WithdrawalModal isOpen={withdrawalModalOpen} onRequestClose={() => setWithdrawalModalOpen(!withdrawalModalOpen)}/>
    <DashboardLayout>
      <div>
        <div css={{}}>
          <div
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      <span>$</span>
                      <span>17892</span>
                      <span css={{ opacity: 0.5, fontWeight: "500" }}>.50</span>
                    </p>
                    <p
                      css={{
                        letterSpacing: "1.6px",
                  ...
                  >
                    <div
                      ...
                      onClick={() => setFundWalletModalOpen(!fundWalletModalOpen)}
                    >
                      Fund wallet
                    </div>
                    <div
